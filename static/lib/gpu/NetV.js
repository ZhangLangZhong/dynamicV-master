...
// var oldLinks = []
// var NowLinks = []
// var oldLinkNodeDataCopy = []
// var changeNodesCopy = []
// var changeLinksCopy = []
// var unchangeLinksCopy = []
// var unchangeNodesCopy = []
// var oldLinkNodeData = []
// var newNodesCopy = []
// var newNodes = []
//             var newLinksCopy = []
...
//             var newLinks1 = []
// // var newNodes
// var nodesGPUunchange = []
// var nodesGPUchange = []
// var linksGPUunchange = []
// var linksGPUchange = []
//             var addAlreadyGPUnodes = []
//             var INTONodes = []
//             var nodesFatherGPU = []
...
class NetV {
     ...
     */
    data(nodeLinkData,nodeXY,linkSource,linkTarget) {
        // var oldNodes = []
        // var nowNodes = []
        // var oldLinks = []
        // var NowLinks = []
        ...
        if (nodeLinkData == undefined) {
            ...
            // console.log(oldLinkNodeData)
            // console.log(nodeLinkData)
            // console.log(oldLinkNodeData.links)
            // console.log(nodeLinkData.nodes)
            // var hashNodeData = []
            // hashNodeData = new HashTable()
            // nodeLinkData.nodes.forEach(function (d){
            //     hashNodeData.add(d.id,d)
            // })

            // console.log(oldLinkNodeData)
            // console.log(oldLinkNodeData.nodes)
            // console.log(oldLinkNodeData)
            // console.log(nodeLinkData)
            // console.log(addAlreadyNodes)
            // console.log(nodeLinkData.links)
            /***
             * 点的情况
             */
            // if (oldLinkNodeData.nodes == undefined){
            //     // console.log(99999)
            //
            //     //没有老数据集 就是这个是第一帧 所有数据视为改变了的数据
            //     changeNodes = nodeLinkData.nodes;
            //     changeLinks = nodeLinkData.links
            // }
            // else {
            //
            //     // console.log(oldLinkNodeData.links)
            ...
            //     //第二帧开始 先建立哈希表
            //     var hashOldLinkData = []
            //     hashOldLinkData = new HashTable()
            //     oldLinkNodeData.links.forEach(function (d) {
            //         var value
            //         // console.log(typeof d.source)   假如出现 0   132   情况
            //         value = d.source  + d.target
            //         // console.log(value)
            //         hashOldLinkData.add(value, d)
            //     })
            //
            //     // console.log(nodeLinkData.links)
            //     // console.log(hashOldLinkData.getValues())
            //
            //     // var a = 0
            //     // a.toString()
            //     // var b = 132
            ...
            //
            //     var hashOldNodeData = []
            //     hashOldNodeData = new HashTable()
            //     oldLinkNodeData.nodes.forEach(function (d) {
            //         hashOldNodeData.add(d.id, d)
            //     })
            //
            //     nodeLinkData.nodes.forEach(function (d) {
            //         if (hashOldNodeData.containsKey(d.id)) {
            //             unchangeNodes.push(d)
            //         } else {
            //             changeNodes.push(d)
            //         }
            //     })
            //
            //     //nodeLinkData.links是节点对
            //     nodeLinkData.links.forEach(function (d) {
            //         var valueNow
            //         valueNow = d.source + d.target
            //         //这个是节点对里面索引信息
            //         // console.log(valueNow)
            //         if (hashOldLinkData.containsKey(valueNow)) {
            //             unchangeLinks.push(d)
            //         } else {
            //             // console.log(valueNow)
            //             changeLinks.push(d)
            //         }
            ...
            //links里面有0132这个边 但是nodes里面没有 132这个点
            // console.log(nodeLinkData.links)
            // console.log(changeNodes)
            // console.log(unchangeNodes)
            // console.log(unchangeLinks)
            // console.log(changeLinks)

            //
            // changeLinksCopy = changeLinks;
            // changeNodesCopy = changeNodes;
            // unchangeLinksCopy = unchangeLinks;
            // unchangeNodesCopy = unchangeNodes;
            //
            // //把这一帧的数据保存为老数据集
            // oldLinkNodeData = nodeLinkData
            ...
            // console.log(nodeLinkData.nodes)
            // console.log(this.$_data.nodes)
            this.addNodes(this.$_data.nodes,nodeXY);
            ...
            //40ms
            this.addLinks(this.$_data.links,nodeXY,linkSource,linkTarget);
    ...
    addNodes(nodesData,nodeXY) {
        ...
        var newNodes = nodesData.map((nodeData11) => {
                // console.log(nodeData11)
                nodeData11.id = nodeData11.id.toString();
                // console.log(nodeData.id)
                var node = new node_1.default(this, nodeData11);
                return node;
            });
        ...
        //只执行第一次
        // if (unchangeNodesCopy.length == 0) {
        //     // console.log(444444)
        //     newNodes = nodesData.map((nodeData11) => {
        //         // console.log(nodeData11)
        //         nodeData11.id = nodeData11.id.toString();
        //         // console.log(nodeData.id)
        //         var node = new node_1.default(this, nodeData11);
        //         return node;
        //     });
        //     changeNodesCopy = newNodes
        //
        // }
        // newNodesCopy = newNodes
        //
        // var hashNewNodesCopy = []
        // hashNewNodesCopy = new HashTable()
        // newNodesCopy.forEach(function (d){
        //     hashNewNodesCopy.add(d.$_id,d)
        // })
        //
        //
        // if (unchangeNodesCopy.length != 0) {
        //     // console.log(888888)
        //     nodesGPUunchange = []
        //     unchangeNodesCopy.forEach(function (d){
        //         if (hashNewNodesCopy.containsKey(d.id)){
        //             nodesGPUunchange.push(hashNewNodesCopy.getValue(d.id))
        //         }
        //     })
        //
        //
        ...
        //     // console.log(changeNodesCopy)
        //     nodesGPUchange = changeNodesCopy.map((nodeData) => {
        //         // console.log(nodeData)
        //         // console.log(nodeData.id)
        //         nodeData.id = nodeData.id.toString();
        //         // console.log(nodeData.id)
        //         var node = new node_1.default(this, nodeData);
        //         // console.log(node)
        //         return node;
        //     });
        //
        //     nodesFatherGPU = addNodeAllLayout.map((nodeData3) => {
        //         // console.log(nodeData)
        //         // console.log(nodeData.id)
        //         nodeData3.id = nodeData3.id.toString();
        //         // console.log(nodeData.id)
        //         var node = new node_1.default(this, nodeData3);
        //         // console.log(node)
        //         return node;
        //     });
        //
        ...
        //
        //     // console.log(addAlreadyNodes)
        //     // addAlreadyGPUnodes = addAlreadyNodes.map((nodeData2) =>{
        //     //     nodeData2.id = nodeData2.id.toString();
        //     //     var node = new node_1.default(this,nodeData2);
        //     //     // console.log(node)
        //     //     return node
        //     // })
        //
        //
        //     changeNodesCopy = nodesGPUchange
        //     INTONodes = nodesFatherGPU
        //     // INTONodes = INTONodes.concat(nodesFatherGPU)
        //     // newNodes = []
        //
        //     // console.log(nodesGPUunchange)
        //     // console.log(nodesGPUchange)
        //
        //     newNodes = []
        //     newNodes = nodesGPUunchange
        // }
        // // console.log(changeNodesCopy)
        // //
        // if (unchangeNodesCopy.length != 0) {
        //     newNodes = newNodes.concat(changeNodesCopy)
        // }
        //
        // newNodesCopy = newNodes
        //
        // console.log(INTONodes)



        //
        // // console.log(newNodesCopy)
        //
        //
        // // console.log(changeNodesCopy)
        // // console.log(changeNodesCopy)
        ...
        // }else{
        //     // console.log(INTONodes)
        //     this.$_renderer.addNodes(INTONodes)
        // }


        this.$_renderer.addNodes(newNodes,nodeXY);
     ...
     * @memberof NetV
     */
    addLinks(linksData,nodeXY,linkSource,linkTarget) {

        var newLinks = new Array(linksData.length);
        ...
        // if (unchangeLinksCopy.length == 0) {
        //     newLinks = new Array(linksData.length);
        //
        //     // console.log(linksData)
        //     for (let i = 0; i < linksData.length; i++) {
        //         const linkData = linksData[i];
        ...
        //         newLinks[i] = link;
        //     }
        //     changeLinksCopy = newLinks
        // }
        //
        // newLinksCopy = newLinks
        //
        // var hashNewLinksCopy = []
        // hashNewLinksCopy = new HashTable()
        // newLinksCopy.forEach(function (d){
        //     // console.log(d)
        //     var LinksValue = []
        //     LinksValue = d.$_source.$_id + d.$_target.$_id
        //     // console.log(LinksValue)
        //     hashNewLinksCopy.add(LinksValue,d)
        // })
        //
        // if (unchangeLinksCopy.length != 0){
        //     linksGPUunchange = []
        //     unchangeLinksCopy.forEach(function (d){
        //         var valueHash = []
        //         valueHash = d.source + d.target
        //         // console.log(valueHash)
        //         if (hashNewLinksCopy.containsKey(valueHash)){
        //             linksGPUunchange.push(hashNewLinksCopy.getValue(valueHash))
        //         }
        //     })
        //     // console.log(linksGPUunchange)
        //
        //     linksGPUchange = new Array(changeLinksCopy.length);
        //     // console.log(changeLinksCopy)
        //     for (let i = 0; i < changeLinksCopy.length; i++) {
        //         var linkData1 = changeLinksCopy[i];
        //         // console.log(linkData1)
        //
        //         linkData1.source = linkData1.source.toString();
        //         linkData1.target = linkData1.target.toString();
        //         // console.log(this)
        //         var link1 = new link_1.default(this, linkData1);
        //
        //         // console.log(link1)
        //
        //         linksGPUchange[i] = link1;
        //
        //     }
        //     // console.log(linksGPUchange)
        //     changeLinksCopy = linksGPUchange
        //
        //     newLinks = []
        //     newLinks = linksGPUunchange
        ...
        //
        // if (unchangeLinksCopy.length != 0){
        //     newLinks = newLinks.concat(changeLinksCopy)
        // }
        // newLinksCopy = newLinks
        //
        // this.$_renderer.addLinks(changeLinksCopy);

        this.$_renderer.addLinks(newLinks,nodeXY,linkSource,linkTarget);
...
class RenderElementManager {
    constructor(gl, params, shaders, idTexture) {
        ...
        // console.log("RenderElementManager")
    ...
    // var attrAttr = []
    addData(elements,nodeXY,linkSource,linkTarget) {
        ...
        // console.log(this.attributes.get("in_shape").array.length)

        // console.log(this.attributes.get("in_shape").array)


        // for (var i = 0;i<this.attributes.get("in_shape").array.length;i++){
        //     var value = 0;
        //     // parseFloat(value)
        //     shapeCopy.push(value)
        // }

        // console.log(this.attributes.get("in_shape"))
        ...
        this.attributes.get("in_shape").isBuildIn = true;

        /**
         * elements为node的情况
         */
        if (elements[0].$_source == undefined){
            // console.log(9999)

            this.attributes.get("in_offset").isBuildIn = true;


            for (var i=0;i<this.attributes.get("in_size").array.length;i++){
                this.attributes.get("in_size").array[i] = 5;
            }
            this.attributes.get("in_size").isBuildIn = true;


            for (var i=0;i<this.attributes.get("in_innerSize").array.length;i++){
                this.attributes.get("in_innerSize").array[i] = 5;
            }
            this.attributes.get("in_innerSize").isBuildIn = true;

            this.attributes.get("in_rotate").isBuildIn = true;


            // console.log(elements.length)
            // console.log(this.attributes.get("in_r").array)
            // for (var i=0;i<elements.length;i++){
            //     // this.attributes.get("in_r").array[i] = 7;
            //     var value = 7
            //     // console.log(this.attributes.get("in_r").array[i])
            //     this.attributes.get("in_r").array[i] = value
            // }
            // this.attributes.get("in_r").isBuildIn = true;
            // console.log(this.attributes.get("in_r").array)

            this.attributes.get("in_r").array.fill(5,0,elements.length)
            // this.attributes.get("in_r").isBuildIn = true;
            ...
            for (var i=0;i<this.attributes.get("in_vertexAlpha").array.length;i++){
                if (i%2 == 0) {
                    this.attributes.get("in_vertexAlpha").array[i] = 0;
                }else{
                    this.attributes.get("in_vertexAlpha").array[i] = -4;
                }
            }
            this.attributes.get("in_vertexAlpha").isBuildIn = true

            for (var i=0;i<this.attributes.get("in_vertexBeta").array.length;i++){
                if (i%2 == 0) {
                    this.attributes.get("in_vertexBeta").array[i] = 3.464101552963257;
                }else{
                    this.attributes.get("in_vertexBeta").array[i] = 2;
                }
            }
            this.attributes.get("in_vertexBeta").isBuildIn = true

            for (var i=0;i<this.attributes.get("in_vertexGamma").array.length;i++){
                if (i%2 == 0) {
                    this.attributes.get("in_vertexGamma").array[i] = 3.464101552963257;
                }else{
                    this.attributes.get("in_vertexGamma").array[i] = 2;
                }
            }
            this.attributes.get("in_vertexGamma").isBuildIn = true
            ...
            for (var i=0;i<elements.length*4;i++){
                if (i%4 == 0) {
                    this.attributes.get("in_fill").array[i] = 1;
                }
                else if (i%4 == 1){
                    this.attributes.get("in_fill").array[i] = 0;
                }
                else if (i%4 == 2){
                    this.attributes.get("in_fill").array[i] = 0.8999999761581421;
                }
                else if (i%4 == 3){
                    this.attributes.get("in_fill").array[i] = 1;
                }
            }
            // console.log(this.attributes.get("in_fill").array)

            // this.attributes.get("in_fill").isBuildIn = true



            for (var i = 0;i<elements.length*2;i++){
                this.attributes.get("in_position").array[i] = nodeXY[i]
            }
            // console.log(this.attributes.get("in_position").array)
            // this.attributes.get("in_position").isBuildIn = true

            // console.log(78877887)
            // console.log(nodeXY)
            // this.attributes.get("in_position").array = nodeXY
            // console.log(this.attributes.get("in_position").array)
            // this.attributes.get("in_position").isBuildIn = true



            for (var i=0;i<this.attributes.get("in_strokeWidth").array.length;i++){
                this.attributes.get("in_strokeWidth").array[i] = 1;
            }
            this.attributes.get("in_strokeWidth").isBuildIn = true;

            for (var i=0;i<elements.length*4;i++){
                if (i%4 == 3) {
                    this.attributes.get("in_strokeColor").array[i] = 0.5;
                }else{
                    this.attributes.get("in_strokeColor").array[i] = 0.09000000357627869;
                }
            }
            // console.log(this.attributes.get("in_strokeColor").array)

            this.attributes.get("in_strokeColor").isBuildIn = true
         ...
         */
            ...
            for (var i=0;i<this.attributes.get("in_curveness").array.length;i++){
                this.attributes.get("in_curveness").array[i] = 0.20000000298023224;
            }
            this.attributes.get("in_curveness").isBuildIn = true;




            for (var i=0;i<this.attributes.get("in_dashInterval").array.length;i++){
                this.attributes.get("in_dashInterval").array[i] = 5;
            }
            this.attributes.get("in_dashInterval").isBuildIn = true;


            for (var i=0;i<this.attributes.get("in_source").array.length;i++){
                this.attributes.get("in_source").array[i] = linkSource[i]
            }
            for (var i=0;i<this.attributes.get("in_target").array.length;i++){
                this.attributes.get("in_target").array[i] = linkTarget[i]
            }



            for (var i=0;i<this.attributes.get("in_strokeWidth").array.length;i++){
                this.attributes.get("in_strokeWidth").array[i] = 1.2000000476837158;
            }
            // this.attributes.get("in_strokeWidth").isBuildIn = true;
        ...
        //
        //     // var attrArray = []
        //     // attrArray = [].concat(this.attributes)
        //     // console.log(attrArray)
        //     // console.log(9999999)
        //     //就是elements每个数据里面attributes里面包含的信息 包含14个
        //     // console.log(this.getAttributeByElement)
        //     //attr开始就是针对的每一个元素内部属性分析
        //
        //     // console.log(this.attributes)
        //     // console.log(this.attributes)
        //
        //     // console.log(999999998889)
        //     // this.attributes.forEach((attr) => {
        //     //     // console.log(1234567)
        //     //     // console.log(attr.name)
        //     //     // if (attr.name == "in_shape"){
        //     //     //
        //     //     //     }
        //     //     //
        //     //     // console.log(attr.array)
        //     //     // console.time()
        //     //     // console.log(attr)
        //     //
        //     //     // if (attr.name == "in_r"){
        ...
        //     //         // console.log(array)
        //     //         // console.log(attr.array)
        //     //         // console.log(attr.size * index)
        //     //         // console.log(88888)
        //     //         // console.log(array)
        //     //
        //     //         // console.log(attr.size)
        //     //
        //     //         if (attr.name != "in_r" && attr.name != "in_fill" && attr.name != "in_strokeWidth" && attr.name !="in_strokeColor" && attr.name != "in_position" && attr.name != "in_source" && attr.name != "in_target") {
        //     //
        //     //
        //     //             array.forEach((v, j) => {
        //     //                 // console.log(index)
        //     //                 // console.log(attr.size)
        //     //                 // console.log(j)
        //     //                 // console.log(attr.size * index + j)
        //     //                 // console.log(attr.size * index + j)
        //     //                 //j该项数据数组的值个数   是数组的索引 比如坐标有两个值 就负责1和2
        //     //                 // console.log(j)
        //     //                 // console.log(111111)
        //     //                 //v是内部的值
        //     //                 // console.log(v)
        ...
        //     //                 // console.log(v)
        //     //                 // console.log(attr)
        //     //                 //index是表示第几个element元素
        //     //                 // console.log(attr.array[attr.size * index + j])
        ...
        //     //
        //     // });
        //     // console.log(attrAttrCopy)
        //     // console.log(attrAttr)
        //     // console.log(this.attributes)
        //     // console.log(this.attributes.get("in_strokeWidth").array)
        //
        //
        //     // attrAttr.push(attrAttrCopy)
        //     // console.log(this.attributes.get("in_shape").array)
        //     // console.timeEnd()
        //     // console.time()
        ...
        // if (elements[0].$_source != undefined) {
        //     console.log(this.attributes.get("in_source").array)
        // }
...
class Renderer {
    ...
    addNodes(nodes,nodeXY) {
        ...
        // console.log(nodes)
        // console.time()
        this.nodeManager.addData(nodes,nodeXY);
        // console.timeEnd()
    }
    /**
     ...
     */
    addLinks(links,nodeXY,linkSource,linkTarget) {

        // console.log(links)
        // console.log(666666666)
        // console.log(linkSource)

        this.linkManager.addData(links,nodeXY,linkSource,linkTarget);
    }
    setTransform(transform) {
